...
class Recommender:
    def __init__(self):
        self.df = pd.read_csv('C:/Users/Admin/Desktop/Tasty-Foods-main/IPYNB File/data.csv')
        self.df['Describe'] = self.df['Describe'].apply(self.text_cleaning)
        self.rating = pd.read_csv('C:/Users/Admin/Desktop/Tasty-Foods-main/IPYNB File/ratings.csv')
